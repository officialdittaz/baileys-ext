...
export class SenderKeyMessage extends CiphertextMessage {
    constructor(keyId, iteration, ciphertext, signatureKey, serialized) {
        ...
        if (serialized) {
            ...
            const message = serialized.slice(1, serialized.length - this
                .SIGNATURE_LENGTH);
            ...
            const version = (((this.CURRENT_VERSION << 4) | this
                .CURRENT_VERSION) & 0xff) % 256;
    ...
    verifySignature(signatureKey) {
        const part1 = this.serialized.slice(0, this.serialized.length - this
            .SIGNATURE_LENGTH);
    ...
    getSignature(signatureKey, serialized) {
        return Buffer.from(curve.calculateSignature(signatureKey,
            serialized));
    }
