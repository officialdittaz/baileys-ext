...
) => Promise<import("../Types/index.js").WAUrlInfo | undefined>;
...
export declare const updateMessageWithEventResponse: (
 ...
 */
export declare function getAggregateResponsesInEventMessage(
 ...
 */
export declare const downloadMediaMessage: <Type extends "buffer" | "stream">(
    message: WAMessage,
    type: Type,
