...
declare const makeWASocket: (config: UserFacingSocketConfig) => {
    ...
    sendMessageAck: (
        { tag, attrs, content }: import("../index.js").BinaryNode,
        errorCode?: number
    ) => Promise<void>;
    sendRetryRequest: (
    ...
    ) => Promise<import("../index.js").WAMessage | undefined>;
    newsletterCreate: (
        name: string,
        description?: string
    ...
    waitForConnectionUpdate: (
        check: (u: Partial<import("../index.js").ConnectionState>) => Promise<boolean | undefined>,
        timeoutMs?: number
    ) => Promise<void>;
